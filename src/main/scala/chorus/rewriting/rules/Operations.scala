package chorus.rewriting.rules

import com.google.common.collect.{ImmutableList, ImmutableSet}
import chorus.dataflow.column.AbstractColumnAnalysis
import chorus.dataflow.domain.AbstractDomain
import chorus.rewriting.rules.Expr.{ColumnReference, ColumnReferenceByName, ColumnReferenceByOrdinal, EnsureAlias, Predicate, QualifiedColumnReference, RelationQualifier, SimpleValueExpr, rexBuilder}
import chorus.rewriting.{RewritingException, WithTable}
import chorus.schema.Database
import chorus.sql.relational_algebra.{Relation, Transformer}
import chorus.sql.{AbstractAnalysis, TreePrinter}
